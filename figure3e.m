...
dt=0.0021; % calculate time step from stability criterion
tau=dt;
r2=v.*v.*dt*dt/dx/dx;
...
for loop=1:1
    ...
    coeff1=[2.42627, -0.749557, 0.236514, -0.068554, 0.016321, -0.00275895, 0.000243906];
